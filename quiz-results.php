...
<head>
  ...
  <style>
    body {
      background: linear-gradient(135deg, #f6f2ff 0%, #fffbec 100%);
    }
    ...
    .ai-explain {
      margin-top: 12px;
      background: linear-gradient(135deg, rgba(92, 51, 246, .05), rgba(92, 51, 246, .02));
      border: 1.5px solid rgba(92, 51, 246, .15);
      border-radius: var(--radius-md);
      padding: 14px 16px;
    }
